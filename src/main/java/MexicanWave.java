...
public class MexicanWave {
    ...
    public static void main(String[] args) {
        ...
        result = new String[]{"Codewars", "cOdewars", "coDewars", "codEwars", "codeWars", "codewArs", "codewaRs", "codewarS"};
        ...
        result = new String[]{"Two words", "tWo words", "twO words", "two Words", "two wOrds", "two woRds", "two worDs", "two wordS"};
    ...
    private static String[] wave1(String str) {
        List<String> res = new ArrayList<>();
        for (int i = 0; i < str.length(); i++) {
            StringBuilder builder = new StringBuilder(str);
            char toUpperCase = builder.charAt(i);
            if (toUpperCase != ' ') {
                res.add(builder.replace(i, i + 1, String.valueOf(toUpperCase).toUpperCase()).toString());
            }
        }
    ...
    /**
     * better solution via functional programming
     * @param str
     * @return
     */
