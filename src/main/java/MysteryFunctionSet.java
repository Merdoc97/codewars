...
public class MysteryFunctionSet {
    ...
    public static void main(String[] args) {
        ...
        assertEquals("mystery(0) ", 0, MysteryFunctionSet.mystery(0));
        assertEquals("mystery(0) ", 1, MysteryFunctionSet.mystery(1));
        assertEquals("mystery(6) ", 5, MysteryFunctionSet.mystery(6));
        assertEquals("mystery(9) ", 13, MysteryFunctionSet.mystery(9));
        assertEquals("mystery(19) ", 26, MysteryFunctionSet.mystery(19));
        assertEquals("mysteryInv(5)", 6, MysteryFunctionSet.mysteryInv(5));
        assertEquals("mysteryInv(13)", 9, MysteryFunctionSet.mysteryInv(13));
        assertEquals("mysteryInv(26)", 19, MysteryFunctionSet.mysteryInv(26));
    }
}
